...
canvas: BG Grid, Pillars CSS, Nav CSS, Video Highlight CSS, Parallax CSS,
Section Tags CSS, and the light block's bleed inside the shared CUSTOM STYLES
embed. Bundled CSS never renders in the Designer. See CONVENTIONS.md.
